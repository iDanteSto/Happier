...
<tr><!-- second segment -->
  <td style="padding: 60px 0 40px 0;" align="center" bgcolor="#787878" class="white">
    ...
    <img src="http://res.cloudinary.com/storagefeed/image/upload/v1517018719/conf4.4.png"  width="191" height="37" style="display: block;" href="{{route('sendEmailDone',["email" => $user->email,"verifyToken"=>$user->verifyToken])}}" />

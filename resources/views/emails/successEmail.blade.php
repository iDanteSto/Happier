                ...
                <table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
                  <tr>
                    <td width="100%" colspan="3" align="center" style="padding-bottom:10px;padding-top:25px;">
                      <div class="contentEditableContainer contentTextEditable">
                        <div class="contentEditable" >
                          <h2 ><strong>Email Confirmado exitosamente!</strong></h2>
                        </div>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td width="400" align="center" style="padding-bottom:5px;">
                      <div class="contentEditableContainer contentTextEditable">
                        <div class="contentEditable" >
                          <p >Para acceder a nuestra app solamente descargala desde la playstore con el link : http:/happier.ciqno.com/app</p>
                        </div>
                      </div>
                    </td>
                    <td width="100">&nbsp;</td>
                      ...
                      <table cellpadding="0" cellspacing="0" border="0" align="center" width="200" height="50">
                        <tr>
                          <td  align="center" style="border-radius:4px;" width="200" height="50">
                            <div class="contentEditableContainer contentTextEditable">
                              <div class="contentEditable" >
                                <img src="http://res.cloudinary.com/storagefeed/image/upload/v1504889235/exito_c6tkto.png" width="300" height='300' alt='Logo'  data-default="placeholder" />
                              </div>
                            </div>
